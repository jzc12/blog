...
| Response Measure（度量） | 受影响工件的数量/大小/复杂度\`\` 工作量/日历时间/资金成本    \`\` 对其他功能/质量属性的影响   \`\` 引入的新缺陷 |
...
| 性能定义                                            | 响应时间构成                                                                                        |
| :-------------------------------------------------- | :-------------------------------------------------------------------------------------------------- |
| 系统满足时序要求的能力\`\`所有系统均有性能需求 | 处理时间 (processing time) —— 系统工作时间\`\` 阻塞时间 (blocked time) —— 系统无法响应时间 |
