import{o as e,c as a,a as o}from"./index-05ebbe09.js";const r={class:"markdown-body"},u="2025-06-04T00:00:00.000Z",c="2025-06-04T00:00:00.000Z",s="NLP",m="nlp 报告",g={__name:"nlp 报告",setup(d,{expose:n}){return n({frontmatter:{date:"2025-06-04T00:00:00.000Z",updated:"2025-06-04T00:00:00.000Z",category:"NLP",summary:"nlp 报告"}}),(i,t)=>(e(),a("div",r,t[0]||(t[0]=[o(`<h1>NLP项目报告</h1><h2>要求</h2><p>1.展示重点：</p><table><thead><tr><th>内容</th><th>建议呈现方式</th></tr></thead><tbody><tr><td>选题意义</td><td>项目的背景动机、研究意义、实用价值、与课程的关联等。</td></tr><tr><td>技术细节</td><td>用图表或代码片段说明核心实现。</td></tr><tr><td>创新点</td><td>突出项目独特之处（如“基于引导的幻觉缓解”对LLM输出的改进）。</td></tr><tr><td>结果对比</td><td>用表格或曲线对比基线模型与本项目的性能差异。</td></tr><tr><td>问题反思</td><td>分析实验中未解决的难点（如“显存换出换入”中的性能瓶颈）。</td></tr></tbody></table><p>2.答辩PPT（建议10页以内），建议包含但不限于以下内容：</p><ul><li><p>项目背景与目标</p><ul><li>说明选题的动机、应用场景及研究意义。</li></ul></li><li><p>技术路线与方法</p><ul><li>使用的模型/算法（PEFT、强化学习、扩散模型等）。</li></ul></li><li><p>模型结构图或系统流程图。</p><ul><li><p>数据集与实验设计</p></li><li><p>数据来源、预处理方法、实验设置（训练参数、评估指标等）。</p></li></ul></li><li><p>实验结果与分析</p><ul><li><p>可视化图表（准确率、损失曲线、生成图像效果）。</p></li><li><p>对比基线模型或现有方法的改进点。</p></li></ul></li><li><p>问题与反思</p><ul><li><p>实验中遇到的挑战及解决方案。</p></li><li><p>项目局限性及未来改进方向。</p></li></ul></li></ul><h2>技术路线与方法</h2><h3>架构图</h3><pre><code class="language-mermaid">flowchart TD
    A[conll2003] --&gt; B[数据预处理]
    B --&gt; C[文本数据]
