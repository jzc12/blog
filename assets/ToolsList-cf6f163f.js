import{aw as V,b4 as U,b5 as $,o as A,c as E,b as f,aP as w,aQ as C,aD as W,aR as j}from"./index-8e24d71d.js";function G(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var n in r)r.hasOwnProperty(n)&&(e[n]=r[n])}return e}function T(e,t){return Array(t+1).join(e)}function O(e){return e.replace(/^\n*/,"")}function S(e){for(var t=e.length;t>0&&e[t-1]===`
`;)t--;return e.substring(0,t)}function D(e){return S(O(e))}var X=["ADDRESS","ARTICLE","ASIDE","AUDIO","BLOCKQUOTE","BODY","CANVAS","CENTER","DD","DIR","DIV","DL","DT","FIELDSET","FIGCAPTION","FIGURE","FOOTER","FORM","FRAMESET","H1","H2","H3","H4","H5","H6","HEADER","HGROUP","HR","HTML","ISINDEX","LI","MAIN","MENU","NAV","NOFRAMES","NOSCRIPT","OL","OUTPUT","P","PRE","SECTION","TABLE","TBODY","TD","TFOOT","TH","THEAD","TR","UL"];function y(e){return N(e,X)}var B=["AREA","BASE","BR","COL","COMMAND","EMBED","HR","IMG","INPUT","KEYGEN","LINK","META","PARAM","SOURCE","TRACK","WBR"];function L(e){return N(e,B)}function K(e){return P(e,B)}var x=["A","TABLE","THEAD","TBODY","TFOOT","TH","TD","IFRAME","SCRIPT","AUDIO","VIDEO"];function Y(e){return N(e,x)}function z(e){return P(e,x)}function N(e,t){return t.indexOf(e.nodeName)>=0}function P(e,t){return e.getElementsByTagName&&t.some(function(r){return e.getElementsByTagName(r).length})}var o={};o.paragraph={filter:"p",replacement:function(e){return`
