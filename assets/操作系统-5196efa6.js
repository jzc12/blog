...
<img src="./../../public/assets/内存管理的概念.png" alt="内存管理的概念" style="zoom:67%;" />

### 进程的内存映像

<img src="./../../public/assets/进程的内存映像.png" alt="进程的内存映像" style="zoom:67%;" />

### 覆盖技术

<img src="./../../public/assets/覆盖技术.png" alt="覆盖技术" style="zoom: 67%;" />

### 交换技术

<img src="./../../public/assets/交换技术.png" alt="交换技术" style="zoom:67%;" />

![内存连续分配](./../../public/assets/内存连续分配.png)
...
![基本地址变换](./../../public/assets/基本地址变换.png)

### 基本分页存储管理



![基本分页存储outline](./../../public/assets/基本分页存储outline.png)

![基本分页存储](./../../public/assets/基本分页存储.png)

### 基本分段存储管理

![基本分段存储outline](./../../public/assets/基本分段存储outline.png)

![基本分段存储](./../../public/assets/基本分段存储.png)
